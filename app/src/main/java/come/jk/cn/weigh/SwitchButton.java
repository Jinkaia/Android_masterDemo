...
public final class SwitchButton extends View {
    ...
    /** 开启状态背景色 */
    protected int mAccentColor = 0xFF6236FF;
    /** 开启状态按钮描边色 */
    protected int mPrimaryDarkColor = 0xFF6236FF;
    /** 关闭状态描边色 */
    ...
    private void initialize(AttributeSet attrs) {
        ...
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.SwitchButton_weigh);
        mChecked = array.getBoolean(R.styleable.SwitchButton_weigh_android_checked, mChecked);
        setEnabled(array.getBoolean(R.styleable.SwitchButton_weigh_android_enabled, isEnabled()));
