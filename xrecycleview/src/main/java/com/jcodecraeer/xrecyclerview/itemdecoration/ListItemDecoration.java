...
public class ListItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public ListItemDecoration(Context context, int orientation, int drawableId) {
...
//        }
    ...
    public void getItemOffsets(Rect outRect, int itemPosition, RecyclerView parent) {
        if (donotRaw(itemPosition, parent.getAdapter().getItemCount())){
            outRect.set(0, 0, 0, 0);
            return;
        }
        if (mOrientation == VERTICAL_LIST) {
    ...
    private boolean donotRaw(int pos, int childCount) {
